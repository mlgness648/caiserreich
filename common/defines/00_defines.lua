...
NCountry = {
	...
	NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_INFRA = 1, -- Reduce enemy national war support on nuking a province, the value scales with infrastructure up to this number
	...
	SPECIAL_FORCES_CAP_MIN = 300,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NMilitary = {
	...
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.05,    -- air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.05,    -- global damage modifier
	...
	LAND_COMBAT_STR_ARMOR_DEFLECTION_FACTOR = 0.45, -- damage reduction if armor outclassing enemy
	LAND_COMBAT_ORG_ARMOR_DEFLECTION_FACTOR = 0.45, -- damage reduction if armor outclassing enemy
	LAND_COMBAT_COLLATERAL_FACTOR = 0.01,		   -- Factor to scale collateral damage to infra and forts with.
	LAND_COMBAT_FORT_DAMAGE_CHANCE = 6,		-- chance to get a hit to damage on forts. (out of 100)
	...
	ATTRITION_WHILE_MOVING_FACTOR = 0.8,
	...
	TACTIC_SWAP_FREQUENCEY = 18,                   -- hours between tactic swaps
	...
	AIR_SUPPORT_BASE = 0.45,                        -- CAS bonus factor for air support moddifier for land unit in combat
...
NNavy = {
	...
	ADMIRAL_TASKFORCE_CAP = 100,										-- admirals will start getting penalties after this amount of taskforces
	...
	COMBAT_BASE_CRITICAL_CHANCE = 0.12,								-- Base chance for receiving a critical chance. It get's scaled down with ship reliability.
	...
	ANTI_AIR_TARGETING = 0.6,                                       -- how good ships are at hitting aircraft
	...
	NAVAL_MINES_IN_REGION_MAX = 0.0,								-- Max number of mines that can be layed by the ships. The value should be hidden from the user, as we present % so it's an abstract value that should be used for balancing.
	NAVAL_MINES_PLANTING_SPEED_MULT = 0.00,						-- Value used to overall balance of the speed of planting naval mines
	NAVAL_MINES_SWEEPING_SPEED_MULT = 0.00,						-- Value used to overall balance of the speed of sweeping naval mines
	NAVAL_MINES_DECAY_AT_PEACE_TIME = 100,							-- How fast mines are decaying in peace time. Planting mines in peace time may be exploitable, so it's blocked atm. That's why after war we should decay them too.
	NAVAL_MINES_SWEEPERS_REDUCTION_ON_PENALTY_EFFECT = 300,			-- How much is the task force's sweeping attribute reducing the penalty effect.
	NAVAL_MINES_INTEL_DIFF_FACTOR = 1,					-- Better our decryption over enemy encryption will reduce the penalties from the enemy mines in the region. This value is a factor to be used for balancing.
	...
	NAVAL_ACCIDENT_CHANCE_REDUCTION_ON_POTF = 0.00,					-- Scale of the current chance for an accident to happen, applied for the pride of the fleet.
	...
	ACCIDENTS_CHANCE_BALANCE_FACTOR = 0,							-- General chance for naval accidents for balancing the gameplay.
	...
	BASE_SPOTTING = 100,												-- base spotting percentage for navy
	...
	POSITIONING_PENALTY_FOR_SHIPS_JOINED_COMBAT_AFTER_IT_STARTS		= 0.06, -- each ship that joins the combat will have this penalty to be added into positioning
	MAX_POSITIONING_PENALTY_FOR_NEWLY_JOINED_SHIPS 					= 0.7,  -- the accumulated penalty from new ships will be clamped to this value
	...
	AA_EFFICIENCY_PENALTY_ON_MINIMUM_POSITIONING					= 1,  -- AA penalty at 0% positioning
...
NAI = {
	...
	NAVY_PREFERED_MAX_SIZE = 130,						-- AI will generally attempt to merge fleets into this size, but as a soft limit.
